...
namespace CosOperation
{
    public static class CosOp
    {
        ...
        public static String UploadFile(string fileName, string path)
        {
            ...
            .SetAppid("1251910132") //设置腾讯云账户的账户标识 APPID
            ...
            try
            {
                string bucket = "chajian-1251910132"; //存储桶，格式：BucketName-APPID
                string key = "whuHelper/CoursesExport/" + fileName; //对象在存储桶中的位置，即称对象键
                ...
                return "https://chajian-1251910132.file.myqcloud.com/whuHelper/CoursesExport/" + fileName;
            }
